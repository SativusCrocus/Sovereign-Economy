...
export function Footer() {
  return (
    <footer className="mx-auto mt-24 w-full max-w-6xl px-4 pb-12">
      <div className="relative overflow-hidden rounded-2xl border border-border bg-white/70 p-6 md:p-8 backdrop-blur-xl shadow-card">
        ...
        <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-xl bg-white ring-1 ring-border">
              <Logo className="h-6 w-6" />
            </span>
            <div className="text-xs">
              <div className="text-sm font-semibold tracking-[0.22em] text-text">DAES</div>
              <div className="mt-1 text-muted">Decentralized Autonomous Economic System</div>
            </div>
          </div>
        ...
        <div className="relative mt-6 hair pt-6">
          <p className="text-[11px] leading-relaxed text-muted">
            Built with Next.js 15 · wagmi v2 · viem · Tailwind CSS · deterministic by construction —
            {" "}<code className="text-accent">numpy.SeedSequence</code> + Chainlink VRF.
